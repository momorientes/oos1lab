...
// Fehler                                               C    |  C++
//enum enumeration { 1st, 2nd, 3rd, 4th };     // Z1      enum muss mit unterstrich oder zahl beginnen     | siehe C 
//enum marks { '1', '2', '3', '4', '5', '6' }; // Z2          enum darf kein string sein | siehe C 
enum class1 { DIETER, HANS, PETER, KAI };    // Z3           |
//enum class2 { ANDREA, KAI, SABINE, ZOE };    // Z4      enum muss eindeutig sein und darf nicht erneut verwendet werden (KAI)| siehe C 
